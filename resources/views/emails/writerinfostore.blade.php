                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1
                                        ...
                                        Hello! {{ $writerName['fname'] }} {{ $writerName['lname'] }}</h1>
                                    <h4
                                        ...
                                        Take our greetings from  WikiLearns!
                                      ...
                                      <p
                                      style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                      Hope you have a great day! Now our editorial board will take a test of yours and check out your writing
                                      skills. Do not try to spin the content or use any unnecessary words. Just get right to the point. We expect
                                      a  100% unique and SEO friendly article from you. Do not try to
                                      use any unnecessary complex sentences.Have a great day! Check out the writing test underneath.
                                                        ...
                                                        <td align="center"
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                        <a href="{{ url('writer-test', [$writerName['data']]) }}"
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <p
                                                    ...
                                                    If you're having trouble clicking the "Writing Test" button,
                                                    ...
                                                    into your web browser: <span class="break-all"
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                            href="{{ url('writer-test', [$writerName['data']]) }}"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ url('writer-test', [$writerName['data']]) }}</a></span>
                                                </p>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p
                                        ...
                                        © 2023 wikileanrs.com All rights reserved.</p>
