...
@section('seo')
    @foreach ($catName as $cat)
        <title>{{ $cat->category_name }} - WiKi Learns</title>
    @endforeach
    ...
    <meta property="og:image" content="{{asset('image/'.$blog->image)}}" /> --}}
...
@section('frontbody')
    ...
    <section id="blog" class="blog" style="padding-top:90px;">
        ...
        <div class="container" data-aos="fade-up">
            <div class="p-5">
                @foreach ($catName as $cat)
                    <h3> Showing Post of :: {{ $cat->category_name }}</h3>
                @endforeach
            </div>
                        ...
                        @foreach ($blogs as $blog)
                            <div class="col-lg-3">
                                <div class="card mb-4" onclick="location.href='{{ Route('getPostbySlug', $blog->slug) }}';">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title text-center display-5 text-dark">{{ $blog->title }}</h5>

                                        <div class="text-center">
                                            <a class="pt-2 text-decoration-none text-center"
                                                href="{{ Route('getPostbySlug', $blog->slug) }}"><span
                                                    class="border-2 btn btn-success btn-sm rounded-pill">Read
                                                    More...</span></a>
                                        </div>
                                        <hr>
                                        <div class="text-center text-dark">
                                            <span><a href="https://www.facebook.com/connectclippingworld/"
                                                    target="_blank"><i
                                            ...
                                            <span><a href="https://www.instagram.com/connectclippingworld/"
                                                    target="_blank"><i
                                                        class="fab fa-3x fa-solid fa-instagram-square text-success"
                                                        style="font-size:30px;"></i></a></span>&nbsp;
                                            <span><a href="https://www.linkedin.com/company/clippingworld2/"
                                                    target="_blank"><i class="fab fa-3x fa-solid fa-linkedin text-success"
                                                        style="font-size:30px;"></i></a></span>&nbsp;
                        ...
                        <div class="">
                            ...
                            <div class="follow-container">
                                ...
                                <span><a href="{{ asset('https://www.facebook.com/connectclippingworld/') }}"
                                        target="_blank"><i
                                            class="fab text-dark fa-3x fa-solid fa-facebook-square"></i></a></span>
                                ...
                                <span><a href="{{ asset('https://www.instagram.com/connectclippingworld/') }}"
                                        target="_blank"><i
                                            class="fab text-dark fa-3x fa-solid fa-instagram-square"></i></a></span>
                                ...
                                <span><a href="{{ asset('https://www.youtube.com/channel/UCLRDqJgwcFOxdpqo7vBxh9Q/featured') }}"
                                        target="_blank"><i
                                            class="fab text-dark fa-3x fa-solid fa-youtube-square"></i></a></span>
                            </div>
                                    ...
                                    <div class="card mb-4"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                <a class="pt-2 text-decoration-none text-center"
                                                    href="{{ Route('getPostbySlug', $blog->slug) }}"><span
                                                        class="border-2 readmore-btn  btn-sm rounded-pill">Read
                                                        More...</span></a>
                                            </div>
                                            <hr>
                                            <div style="padding: 20px">
                                                <div class="share-button">
                                                    <div class="share-button__back">
                                                        <a class="share__link fShare" href="#" title="twitter"><i
                                                                class="d-flex justify-content-center fab fa-facebook-f">
                                                            </i></a>
                                                        <a class="share__link fShare" href="#" title="facebook"> <i
                                                                class="d-flex justify-content-center  fab fa-twitter">
                                                            </i></a>
                                                        <a class="share__link fShare" href="#"
                                                            title="google plus"><i
                                                                class="d-flex justify-content-center fab fa-linkedin"> </i>
                                                        </a>
                                                        <a class="share__link fShare" href="#" title="dribbble"><i
